...
namespace com.precisely.apis.Api
{
    ...
    public partial class PropertyInformationServiceApi : IPropertyInformationServiceApi
    {
        ...
        /// <summary>
        /// Get Property Attributes By Address Accepts address as input and returns property attributes for the matched address.
        /// </summary>
        /// <exception cref="com.precisely.apis.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="address">free form address text</param>
        /// <returns>GeoPropertyResponse</returns>
        ...
        public ApiResponse< GeoPropertyResponse > GetGeoPropertyByAddressWithHttpInfo (string address)
        {
            ...
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling PropertyInformationServiceApi->GetGeoPropertyByAddress");

            var localVarPath = "/property/v1/all/attributes/byaddress";
        ...
        /// <summary>
        /// Post Property Attributes By Address This is a Batch offering for &#39;Property Attributes By Address&#39; service. It accepts a single address or a list of addresses and returns property attributes for the matched address.
        /// </summary>
        /// <exception cref="com.precisely.apis.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"> (optional)</param>
        /// <returns>GeoPropertyResponses</returns>
