...
namespace com.precisely.apis.Api
{
    ...
    public interface IPropertyInformationServiceApi : IApiAccessor
    {
        ...
        ApiResponse<PropertyInfoResponse> GetPropertyAttributesByAddressWithHttpInfo (string address = null, string attributes = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PropertyInfoResponse> GetPropertyAttributesByAddressAsync (string address = null, string attributes = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PropertyInfoResponse>> GetPropertyAttributesByAddressAsyncWithHttpInfo (string address = null, string attributes = null);
        /// <summary>
        /// PropertyV2 Attributes By Address Batch.
        /// </summary>
        /// <remarks>
    ...
    public partial class PropertyInformationServiceApi : IPropertyInformationServiceApi
    {
        ...
        /// <param name="attributes">Case-insensitive comma separated values of property attributes. Response will contain only the input attributes. (optional)</param>
        /// <returns>PropertyInfoResponse</returns>
        public PropertyInfoResponse GetPropertyAttributesByAddress (string address = null, string attributes = null)
        {
        ...
        /// <param name="attributes">Case-insensitive comma separated values of property attributes. Response will contain only the input attributes. (optional)</param>
        /// <returns>ApiResponse of PropertyInfoResponse</returns>
        public ApiResponse< PropertyInfoResponse > GetPropertyAttributesByAddressWithHttpInfo (string address = null, string attributes = null)
        {
        ...
        /// <param name="attributes">Case-insensitive comma separated values of property attributes. Response will contain only the input attributes. (optional)</param>
        /// <returns>Task of PropertyInfoResponse</returns>
        public async System.Threading.Tasks.Task<PropertyInfoResponse> GetPropertyAttributesByAddressAsync (string address = null, string attributes = null)
        {
             ApiResponse<PropertyInfoResponse> localVarResponse = await GetPropertyAttributesByAddressAsyncWithHttpInfo(address, attributes);
             return localVarResponse.Data;
        ...
        /// <param name="attributes">Case-insensitive comma separated values of property attributes. Response will contain only the input attributes. (optional)</param>
        /// <returns>Task of ApiResponse (PropertyInfoResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PropertyInfoResponse>> GetPropertyAttributesByAddressAsyncWithHttpInfo (string address = null, string attributes = null)
        {
