...
namespace com.precisely.apis.Api
{
    ...
    /// </summary>
    public interface ITypeaheadServiceApi : IApiAccessor
    {
        ...
        ApiResponse<GeosearchLocations> SearchWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null);
        ...
        System.Threading.Tasks.Task<GeosearchLocations> SearchAsync (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GeosearchLocations>> SearchAsyncWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TypeaheadServiceApi : ITypeaheadServiceApi
    {
        private com.precisely.apis.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TypeaheadServiceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TypeaheadServiceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public TypeaheadServiceApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Typeahead Search Performs search to retrieve list of places by input text and location vicinity.
        /// </summary>
        /// <exception cref="com.precisely.apis.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="searchText">The input to be searched.</param>
        /// <param name="latitude">Latitude of the location. Either the latitude or the longitude must be provided. (optional)</param>
        ...
        /// <param name="searchType">Preference to control search type of interactive requests. (optional, default to ADDRESS)</param>
        /// <returns>GeosearchLocations</returns>
        public GeosearchLocations Search (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null)
        {
             ApiResponse<GeosearchLocations> localVarResponse = SearchWithHttpInfo(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType);
        ...
        /// <param name="searchType">Preference to control search type of interactive requests. (optional, default to ADDRESS)</param>
        /// <returns>ApiResponse of GeosearchLocations</returns>
        public ApiResponse< GeosearchLocations > SearchWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null)
        {
            // verify the required parameter 'searchText' is set
            if (searchText == null)
                throw new ApiException(400, "Missing required parameter 'searchText' when calling TypeaheadServiceApi->Search");
        ...
        /// <param name="searchType">Preference to control search type of interactive requests. (optional, default to ADDRESS)</param>
        /// <returns>Task of GeosearchLocations</returns>
        public async System.Threading.Tasks.Task<GeosearchLocations> SearchAsync (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null)
        {
             ApiResponse<GeosearchLocations> localVarResponse = await SearchAsyncWithHttpInfo(searchText, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType);
             return localVarResponse.Data;
        ...
        /// <param name="searchType">Preference to control search type of interactive requests. (optional, default to ADDRESS)</param>
        /// <returns>Task of ApiResponse (GeosearchLocations)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GeosearchLocations>> SearchAsyncWithHttpInfo (string searchText, string latitude = null, string longitude = null, string searchRadius = null, string searchRadiusUnit = null, string maxCandidates = null, string country = null, string matchOnAddressNumber = null, string autoDetectLocation = null, string ipAddress = null, string areaName1 = null, string areaName3 = null, string postCode = null, string returnAdminAreasOnly = null, string includeRangesDetails = null, string searchType = null)
        {
            // verify the required parameter 'searchText' is set
            if (searchText == null)
                throw new ApiException(400, "Missing required parameter 'searchText' when calling TypeaheadServiceApi->Search");
