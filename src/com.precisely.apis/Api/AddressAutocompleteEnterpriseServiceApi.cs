...
namespace com.precisely.apis.Api
{
    ...
    public interface IAddressAutocompleteEnterpriseServiceApi : IApiAccessor
    {
        ...
        TypeaheadLocations ListLocations (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string));
        ...
        System.Threading.Tasks.Task<TypeaheadLocations> ListLocationsAsync (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), CancellationToken cancellationToken = default(CancellationToken));
