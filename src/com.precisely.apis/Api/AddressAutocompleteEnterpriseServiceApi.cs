...
namespace com.precisely.apis.Api
{
    ...
    /// </summary>
    public interface IAddressAutocompleteEnterpriseServiceApi : IApiAccessor
    {
        ...
        TypeaheadLocations ListLocations (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), string searchOnUnitInfo = default(string));
        ...
        ApiResponse<TypeaheadLocations> ListLocationsWithHttpInfo (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), string searchOnUnitInfo = default(string));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="com.precisely.apis.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="selectedAddress">Selected Address to be searched.</param>
        /// <param name="transactionId">transactionId.</param>
        /// <param name="country">Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)</param>
        /// <returns>Object</returns>
        Object ListSelect (string selectedAddress, string transactionId, string country = default(string));
        ...
        ApiResponse<Object> ListSelectWithHttpInfo (string selectedAddress, string transactionId, string country = default(string));
        ...
        System.Threading.Tasks.Task<TypeaheadLocations> ListLocationsAsync (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), string searchOnUnitInfo = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TypeaheadLocations>> ListLocationsWithHttpInfoAsync (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), string searchOnUnitInfo = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Object> ListSelectAsync (string selectedAddress, string transactionId, string country = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ListSelectWithHttpInfoAsync (string selectedAddress, string transactionId, string country = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AddressAutocompleteEnterpriseServiceApi : IAddressAutocompleteEnterpriseServiceApi
    {
        private com.precisely.apis.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AddressAutocompleteEnterpriseServiceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AddressAutocompleteEnterpriseServiceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AddressAutocompleteEnterpriseServiceApi(com.precisely.apis.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<TypeaheadLocations> ListLocationsWithHttpInfo (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), string searchOnUnitInfo = default(string))
        {
            ...
            if (searchText == null)
                throw new ApiException(400, "Missing required parameter 'searchText' when calling AddressAutocompleteEnterpriseServiceApi->ListLocations");
            // verify the required parameter 'transactionId' is set
            if (transactionId == null)
                throw new ApiException(400, "Missing required parameter 'transactionId' when calling AddressAutocompleteEnterpriseServiceApi->ListLocations");

            var localVarPath = "/typeahead/v1/list/locations";
            ...
            if (transactionId != null) localVarQueryParams.Add("transactionId", Configuration.ApiClient.ParameterToString(transactionId)); // query parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TypeaheadLocations</returns>
        public async System.Threading.Tasks.Task<TypeaheadLocations> ListLocationsAsync (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), string searchOnUnitInfo = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<TypeaheadLocations> localVarResponse = await ListLocationsWithHttpInfoAsync(searchText, transactionId, latitude, longitude, searchRadius, searchRadiusUnit, maxCandidates, country, matchOnAddressNumber, autoDetectLocation, ipAddress, areaName1, areaName3, postCode, returnAdminAreasOnly, includeRangesDetails, searchType, searchOnAddressNumber, searchOnUnitInfo, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TypeaheadLocations)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TypeaheadLocations>> ListLocationsWithHttpInfoAsync (string searchText, string transactionId, string latitude = default(string), string longitude = default(string), string searchRadius = default(string), string searchRadiusUnit = default(string), string maxCandidates = default(string), string country = default(string), string matchOnAddressNumber = default(string), string autoDetectLocation = default(string), string ipAddress = default(string), string areaName1 = default(string), string areaName3 = default(string), string postCode = default(string), string returnAdminAreasOnly = default(string), string includeRangesDetails = default(string), string searchType = default(string), string searchOnAddressNumber = default(string), string searchOnUnitInfo = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'searchText' is set
            if (searchText == null)
                throw new ApiException(400, "Missing required parameter 'searchText' when calling AddressAutocompleteEnterpriseServiceApi->ListLocations");
        ...
        /// <param name="country">Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)</param>
        /// <returns>Object</returns>
        public Object ListSelect (string selectedAddress, string transactionId, string country = default(string))
        {
             ApiResponse<Object> localVarResponse = ListSelectWithHttpInfo(selectedAddress, transactionId, country);
             return localVarResponse.Data;
        }
        ...
        /// <param name="country">Country ISO code. We need to make sure that either Lat/Lng or Country is provided to API (optional)</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse<Object> ListSelectWithHttpInfo (string selectedAddress, string transactionId, string country = default(string))
        {
            // verify the required parameter 'selectedAddress' is set
            if (selectedAddress == null)
                throw new ApiException(400, "Missing required parameter 'selectedAddress' when calling AddressAutocompleteEnterpriseServiceApi->ListSelect");
            // verify the required parameter 'transactionId' is set
            if (transactionId == null)
                throw new ApiException(400, "Missing required parameter 'transactionId' when calling AddressAutocompleteEnterpriseServiceApi->ListSelect");

            var localVarPath = "/typeahead/v1/list/select";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (selectedAddress != null) localVarQueryParams.Add("selectedAddress", Configuration.ApiClient.ParameterToString(selectedAddress)); // query parameter
            if (country != null) localVarQueryParams.Add("country", Configuration.ApiClient.ParameterToString(country)); // query parameter
            if (transactionId != null) localVarQueryParams.Add("transactionId", Configuration.ApiClient.ParameterToString(transactionId)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListSelect", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> ListSelectAsync (string selectedAddress, string transactionId, string country = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Object> localVarResponse = await ListSelectWithHttpInfoAsync(selectedAddress, transactionId, country, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> ListSelectWithHttpInfoAsync (string selectedAddress, string transactionId, string country = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'selectedAddress' is set
            if (selectedAddress == null)
                throw new ApiException(400, "Missing required parameter 'selectedAddress' when calling AddressAutocompleteEnterpriseServiceApi->ListSelect");
