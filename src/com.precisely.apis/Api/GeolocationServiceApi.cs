...
namespace com.precisely.apis.Api
{
    ...
    public partial class GeolocationServiceApi : IGeolocationServiceApi
    {
        ...
        /// <returns></returns>
        public GeolocationServiceApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< GeoLocationDeviceSatus > GetDeviceStatusWithHttpInfo (string deviceId, string includeNetworkInfo_ = null)
        {
            ...
            if (deviceId == null)
                throw new ApiException(400, "Missing required parameter 'deviceId' when calling GeolocationServiceApi->GetDeviceStatus");
