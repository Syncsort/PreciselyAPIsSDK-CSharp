...
namespace com.precisely.apis.Api
{
    ...
    public partial class LocalTaxServiceApi : ILocalTaxServiceApi
    {
        ...
        /// <returns></returns>
        public LocalTaxServiceApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< TaxResponses > GetBatchTaxByAddressWithHttpInfo (string taxRateTypeId, TaxAddressRequest body)
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LocalTaxServiceApi->GetBatchTaxByAddress");
        ...
        public ApiResponse< TaxLocationResponses > GetBatchTaxByLocationWithHttpInfo (string taxRateTypeId, TaxLocationRequest body)
        {
            ...
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LocalTaxServiceApi->GetBatchTaxByLocation");
        ...
        public ApiResponse< TaxRateResponses > GetBatchTaxRateByAddressWithHttpInfo (string taxRateTypeId, TaxRateAddressRequest body)
        {
            ...
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LocalTaxServiceApi->GetBatchTaxRateByAddress");
        ...
        public ApiResponse< TaxRateLocationResponses > GetBatchTaxRateByLocationWithHttpInfo (string taxRateTypeId, TaxRateLocationRequest body)
        {
            ...
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LocalTaxServiceApi->GetBatchTaxRateByLocation");
        ...
        public ApiResponse< TaxDistrictResponseList > GetIPDTaxByAddressBatchWithHttpInfo (IPDTaxByAddressBatchRequest body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LocalTaxServiceApi->GetIPDTaxByAddressBatch");
