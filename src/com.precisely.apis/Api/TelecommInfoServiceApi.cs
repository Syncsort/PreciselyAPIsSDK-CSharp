...
namespace com.precisely.apis.Api
{
    ...
    public partial class TelecommInfoServiceApi : ITelecommInfoServiceApi
    {
        ...
        /// <returns></returns>
        public TelecommInfoServiceApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< RateCenterResponse > GetRateCenterByAddressWithHttpInfo (string address, string country = null, string areaCodeInfo = null, string level = null)
        {
            ...
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling TelecommInfoServiceApi->GetRateCenterByAddress");
        ...
        public ApiResponse< RateCenterResponse > GetRateCenterByLocationWithHttpInfo (string longitude, string latitude, string areaCodeInfo = null, string level = null)
        {
            ...
            if (longitude == null)
                throw new ApiException(400, "Missing required parameter 'longitude' when calling TelecommInfoServiceApi->GetRateCenterByLocation");
            // verify the required parameter 'latitude' is set
            if (latitude == null)
                throw new ApiException(400, "Missing required parameter 'latitude' when calling TelecommInfoServiceApi->GetRateCenterByLocation");
