...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SupplyAndDemandTheme :  IEquatable<SupplyAndDemandTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public SupplyAndDemandTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as SupplyAndDemandTheme);
        }

        /// <summary>
        /// Returns true if SupplyAndDemandTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of SupplyAndDemandTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupplyAndDemandTheme input)
        {
            if (input == null)
                return false;
