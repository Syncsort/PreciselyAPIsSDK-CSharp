...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FireRiskByLocationRequest :  IEquatable<FireRiskByLocationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public FireRiskByLocationRequest(List<RiskLocations> locations = default(List<RiskLocations>), RiskPreferences preferences = default(RiskPreferences))
        {
        ...
        {
            return this.Equals(input as FireRiskByLocationRequest);
        }

        /// <summary>
        /// Returns true if FireRiskByLocationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FireRiskByLocationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FireRiskByLocationRequest input)
        {
            if (input == null)
                return false;
