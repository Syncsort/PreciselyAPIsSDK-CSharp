...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPostalCodesAPIOutput :  IEquatable<GetPostalCodesAPIOutput>
    {
        /// <summary>
        ...
        public GetPostalCodesAPIOutput(List<ValidateMailingAddressInputRowUserFields> UserFields = null, string PostalCode = null, string CityType = null, string Status = null, string StatusCode = null, string StatusDescription = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetPostalCodesAPIOutput);
        }

        /// <summary>
        /// Returns true if GetPostalCodesAPIOutput instances are equal
        /// </summary>
        /// <param name="other">Instance of GetPostalCodesAPIOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPostalCodesAPIOutput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
