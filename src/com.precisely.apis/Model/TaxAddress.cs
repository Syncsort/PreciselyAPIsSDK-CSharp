...
namespace com.precisely.apis.Model
{
    ...
    public partial class TaxAddress :  IEquatable<TaxAddress>, IValidatableObject
    {
        ...
        public TaxAddress(string objectId = default(string), string displayName = default(string), string streetSide = default(string), string businessName = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string city = default(string), string stateProvince = default(string), string county = default(string), string postalCode = default(string), string latitude = default(string), string longitude = default(string), string status = default(string), string urbanizationName = default(string), string formattedAddress = default(string), string mainAddressLine = default(string), string addressLastLine = default(string), string placeName = default(string), string areaName1 = default(string), string areaName2 = default(string), string areaName3 = default(string), string areaName4 = default(string), string postCode = default(string), string postCode1 = default(string), string postCodeExt = default(string), string country = default(string), string addressNumber = default(string), string streetName = default(string), string unitType = default(string), string unitValue = default(string), string distanceUnits = default(string), string bufferWidth = default(string), string userBufferWidth = default(string), string purchaseAmount = default(string))
        {
