...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BuildgImprovArea :  IEquatable<BuildgImprovArea>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildgImprovArea" /> class.
        /// </summary>
        /// <param name="improveArea">improveArea.</param>
        /// <param name="areaIndicator">areaIndicator.</param>
        /// <param name="description">description.</param>
        public BuildgImprovArea(string improveArea = default(string), string areaIndicator = default(string), string description = default(string))
        {
        ...
        {
            return this.Equals(input as BuildgImprovArea);
        }

        /// <summary>
        /// Returns true if BuildgImprovArea instances are equal
        /// </summary>
        /// <param name="input">Instance of BuildgImprovArea to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuildgImprovArea input)
        {
            if (input == null)
                return false;
