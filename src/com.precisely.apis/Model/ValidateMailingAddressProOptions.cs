...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ValidateMailingAddressProOptions :  IEquatable<ValidateMailingAddressProOptions>, IValidatableObject
    {
        /// <summary>
        ...
        public ValidateMailingAddressProOptions(string outputAddressBlocks = "Y", string keepMultimatch = "N", string outputCountryFormat = "E", string outputScript = "InputScript", string outputCasing = "M", string maximumResults = "10")
        {
        ...
        {
            return this.Equals(input as ValidateMailingAddressProOptions);
        }

        /// <summary>
        /// Returns true if ValidateMailingAddressProOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateMailingAddressProOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateMailingAddressProOptions input)
        {
            if (input == null)
                return false;
