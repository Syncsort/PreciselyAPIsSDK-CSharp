...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RaceAndEthnicityTheme :  IEquatable<RaceAndEthnicityTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public RaceAndEthnicityTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as RaceAndEthnicityTheme);
        }

        /// <summary>
        /// Returns true if RaceAndEthnicityTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of RaceAndEthnicityTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RaceAndEthnicityTheme input)
        {
            if (input == null)
                return false;
