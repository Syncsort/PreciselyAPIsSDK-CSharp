...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DistanceToFloodHazardAddressRequest :  IEquatable<DistanceToFloodHazardAddressRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public DistanceToFloodHazardAddressRequest(List<RiskAddress> addresses = default(List<RiskAddress>), FloodHazardPreferences preferences = default(FloodHazardPreferences))
        {
        ...
        {
            return this.Equals(input as DistanceToFloodHazardAddressRequest);
        }

        /// <summary>
        /// Returns true if DistanceToFloodHazardAddressRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DistanceToFloodHazardAddressRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistanceToFloodHazardAddressRequest input)
        {
            if (input == null)
                return false;
