...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EducationTheme :  IEquatable<EducationTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public EducationTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as EducationTheme);
        }

        /// <summary>
        /// Returns true if EducationTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of EducationTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EducationTheme input)
        {
            if (input == null)
                return false;
