...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PoiCountRequest :  IEquatable<PoiCountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PoiCountRequest(string name = default(string), string type = default(string), string categoryCode = default(string), string sicCode = default(string), string fuzzyOnName = default(string), string matchMode = default(string), string specificMatchOn = default(string), Geometry geometry = default(Geometry), string geometryAsText = default(string))
        {
            this.Name = name;
            this.Type = type;
        ...
        {
            return this.Equals(input as PoiCountRequest);
        }

        /// <summary>
        /// Returns true if PoiCountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PoiCountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoiCountRequest input)
        {
            if (input == null)
                return false;
