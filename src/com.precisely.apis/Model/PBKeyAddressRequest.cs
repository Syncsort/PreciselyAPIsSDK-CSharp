...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PBKeyAddressRequest :  IEquatable<PBKeyAddressRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PBKeyAddressRequest(List<GeocodeAddress> addresses = default(List<GeocodeAddress>))
        {
        ...
        {
            return this.Equals(input as PBKeyAddressRequest);
        }

        /// <summary>
        /// Returns true if PBKeyAddressRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PBKeyAddressRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PBKeyAddressRequest input)
        {
            if (input == null)
                return false;
