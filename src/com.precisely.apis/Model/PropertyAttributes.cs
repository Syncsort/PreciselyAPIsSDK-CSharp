...
namespace com.precisely.apis.Model
{
    ...
    public partial class PropertyAttributes :  IEquatable<PropertyAttributes>, IValidatableObject
    {
        ...
        /// <param name="propCensusTract">propCensusTract.</param>
        ...
        /// <param name="buildgImprovArea">buildgImprovArea.</param>
        ...
        /// <summary>
        /// Gets or Sets PropCensusTract
        /// </summary>
        [DataMember(Name="propCensusTract", EmitDefaultValue=false)]
        public string PropCensusTract { get; set; }
        ...
        /// <summary>
        /// Gets or Sets BuildgImprovArea
        /// </summary>
        [DataMember(Name="buildgImprovArea", EmitDefaultValue=false)]
        public List<BuildgImprovArea> BuildgImprovArea { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PropCensusTract: ").Append(PropCensusTract).Append("\n");
            ...
            sb.Append("  BuildgImprovArea: ").Append(BuildgImprovArea).Append("\n");
        ...
        public bool Equals(PropertyAttributes input)
        {
            ...
            return 
                ...
                (
                    this.PropCensusTract == input.PropCensusTract ||
                    (this.PropCensusTract != null &&
                    this.PropCensusTract.Equals(input.PropCensusTract))
                ) && 
                (
                ...
                (
                    this.BuildgImprovArea == input.BuildgImprovArea ||
                    this.BuildgImprovArea != null &&
                    input.BuildgImprovArea != null &&
                    this.BuildgImprovArea.SequenceEqual(input.BuildgImprovArea)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PropCensusTract != null)
                    hashCode = hashCode * 59 + this.PropCensusTract.GetHashCode();
                ...
                if (this.BuildgImprovArea != null)
                    hashCode = hashCode * 59 + this.BuildgImprovArea.GetHashCode();
