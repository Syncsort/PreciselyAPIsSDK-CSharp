...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HousingTheme :  IEquatable<HousingTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public HousingTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as HousingTheme);
        }

        /// <summary>
        /// Returns true if HousingTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of HousingTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HousingTheme input)
        {
            if (input == null)
                return false;
