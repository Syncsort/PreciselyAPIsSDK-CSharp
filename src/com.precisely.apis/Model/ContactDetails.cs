...
namespace com.precisely.apis.Model
{
    ...
    public partial class ContactDetails :  IEquatable<ContactDetails>, IValidatableObject
    {
        ...
        public ContactDetails(Address1 address = default(Address1), string phone = default(string), string fax = default(string), string countryAccessCode = default(string), string email = default(string), string url = default(string))
        {
