...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DistanceToFloodHazardLocationRequest :  IEquatable<DistanceToFloodHazardLocationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public DistanceToFloodHazardLocationRequest(List<RiskLocations> locations = default(List<RiskLocations>), FloodHazardPreferences preferences = default(FloodHazardPreferences))
        {
        ...
        {
            return this.Equals(input as DistanceToFloodHazardLocationRequest);
        }

        /// <summary>
        /// Returns true if DistanceToFloodHazardLocationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DistanceToFloodHazardLocationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistanceToFloodHazardLocationRequest input)
        {
            if (input == null)
                return false;
