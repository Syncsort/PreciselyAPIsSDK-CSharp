...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpenditureTheme :  IEquatable<ExpenditureTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public ExpenditureTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as ExpenditureTheme);
        }

        /// <summary>
        /// Returns true if ExpenditureTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenditureTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenditureTheme input)
        {
            if (input == null)
                return false;
