...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ZonesPoiClassification :  IEquatable<ZonesPoiClassification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZonesPoiClassification" /> class.
        /// </summary>
        /// <param name="sic">sic.</param>
        /// <param name="category">category.</param>
        /// <param name="alternateIndustryCode">alternateIndustryCode.</param>
        public ZonesPoiClassification(ZonesSic sic = default(ZonesSic), Category category = default(Category), string alternateIndustryCode = default(string))
        {
            this.Sic = sic;
        ...
        {
            return this.Equals(input as ZonesPoiClassification);
        }

        /// <summary>
        /// Returns true if ZonesPoiClassification instances are equal
        /// </summary>
        /// <param name="input">Instance of ZonesPoiClassification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZonesPoiClassification input)
        {
            if (input == null)
                return false;
