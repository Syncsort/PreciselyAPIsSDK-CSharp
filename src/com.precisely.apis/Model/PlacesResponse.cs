...
namespace com.precisely.apis.Model
{
    ...
    public partial class PlacesResponse :  IEquatable<PlacesResponse>, IValidatableObject
    {
        ...
        public PlacesResponse(string page = default(string), string candidates = default(string), string totalMatchingCandidates = default(string), List<Poi> poi = default(List<Poi>), Address1 matchedAddress = default(Address1))
        {
            this.Page = page;
