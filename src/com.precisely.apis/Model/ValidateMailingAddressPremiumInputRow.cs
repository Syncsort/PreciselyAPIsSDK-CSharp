...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ValidateMailingAddressPremiumInputRow :  IEquatable<ValidateMailingAddressPremiumInputRow>, IValidatableObject
    {
        /// <summary>
        ...
        public ValidateMailingAddressPremiumInputRow(List<GetPostalCodesAPIOutputUserFields> userFields = default(List<GetPostalCodesAPIOutputUserFields>), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), string addressLine5 = default(string), string firmName = default(string), string city = default(string), string stateProvince = default(string), string country = default(string), string postalCode = default(string))
        {
        ...
        {
            return this.Equals(input as ValidateMailingAddressPremiumInputRow);
        }

        /// <summary>
        /// Returns true if ValidateMailingAddressPremiumInputRow instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateMailingAddressPremiumInputRow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateMailingAddressPremiumInputRow input)
        {
            if (input == null)
                return false;
