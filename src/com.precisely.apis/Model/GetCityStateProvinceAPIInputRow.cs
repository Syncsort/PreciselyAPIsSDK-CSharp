...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCityStateProvinceAPIInputRow :  IEquatable<GetCityStateProvinceAPIInputRow>
    {
        /// <summary>
        ...
        public GetCityStateProvinceAPIInputRow(List<ValidateMailingAddressInputRowUserFields> UserFields = null, string PostalCode = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCityStateProvinceAPIInputRow);
        }

        /// <summary>
        /// Returns true if GetCityStateProvinceAPIInputRow instances are equal
        /// </summary>
        /// <param name="other">Instance of GetCityStateProvinceAPIInputRow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCityStateProvinceAPIInputRow other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
