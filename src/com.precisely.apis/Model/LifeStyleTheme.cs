...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LifeStyleTheme :  IEquatable<LifeStyleTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public LifeStyleTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as LifeStyleTheme);
        }

        /// <summary>
        /// Returns true if LifeStyleTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of LifeStyleTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LifeStyleTheme input)
        {
            if (input == null)
                return false;
