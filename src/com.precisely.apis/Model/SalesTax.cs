...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesTax :  IEquatable<SalesTax>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SalesTax);
        }

        /// <summary>
        /// Returns true if SalesTax instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesTax to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesTax input)
        {
            if (input == null)
                return false;
