...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssetsAndWealthTheme :  IEquatable<AssetsAndWealthTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public AssetsAndWealthTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as AssetsAndWealthTheme);
        }

        /// <summary>
        /// Returns true if AssetsAndWealthTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetsAndWealthTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetsAndWealthTheme input)
        {
            if (input == null)
                return false;
