...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Match1 :  IEquatable<Match1>, IValidatableObject
    {
        /// <summary>
        ...
        public Match1(string confidence = default(string), string percentGeocode = default(string), string precisionLevel = default(string), string locationCode = default(string), string matchCode = default(string))
        {
        ...
        {
            return this.Equals(input as Match1);
        }

        /// <summary>
        /// Returns true if Match1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Match1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Match1 input)
        {
            if (input == null)
                return false;
