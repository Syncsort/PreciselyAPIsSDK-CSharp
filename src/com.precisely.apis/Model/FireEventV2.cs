...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FireEventV2 :  IEquatable<FireEventV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FireEventV2" /> class.
        /// </summary>
        ...
        public FireEventV2(string fireStartDate = default(string), string fireEndDate = default(string), string fireName = default(string), AreaV2 area = default(AreaV2), string agency = default(string))
        {
        ...
        {
            return this.Equals(input as FireEventV2);
        }

        /// <summary>
        /// Returns true if FireEventV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of FireEventV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FireEventV2 input)
        {
            if (input == null)
                return false;
