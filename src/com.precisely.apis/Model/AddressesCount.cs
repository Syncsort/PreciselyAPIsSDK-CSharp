...
namespace com.precisely.apis.Model
{
    ...
    public partial class AddressesCount :  IEquatable<AddressesCount>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AddressesCount);
        }

        /// <summary>
        /// Returns true if AddressesCount instances are equal
        /// </summary>
        /// <param name="other">Instance of AddressesCount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressesCount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.TotalAddressesFound == other.TotalAddressesFound ||
                    this.TotalAddressesFound != null &&
                    this.TotalAddressesFound.Equals(other.TotalAddressesFound)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TotalAddressesFound != null)
                    hash = hash * 59 + this.TotalAddressesFound.GetHashCode();
                return hash;
            }
        }
    }
