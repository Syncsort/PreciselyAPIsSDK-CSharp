...
namespace com.precisely.apis.Model
{
    ...
    public partial class SchoolsNearByResponse :  IEquatable<SchoolsNearByResponse>, IValidatableObject
    {
        ...
        public SchoolsNearByResponse(Address1 matchedAddress = default(Address1), List<School> school = default(List<School>), SchoolDistrict schoolDistrict = default(SchoolDistrict))
        {
