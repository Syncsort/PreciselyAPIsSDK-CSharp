...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ErrorCode :  IEquatable<ErrorCode>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorCode" /> class.
        /// </summary>
        /// <param name="_ErrorCode">_ErrorCode.</param>
        /// <param name="ErrorDescription">ErrorDescription.</param>
        public ErrorCode(string _ErrorCode = null, string ErrorDescription = null)
        {
        ...
        /// </summary>
        /// <param name="other">Instance of ErrorCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorCode other)
        {
            ...
            return 
                (
                    ...
                    this._ErrorCode.Equals(other._ErrorCode)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._ErrorCode != null)
                    hash = hash * 59 + this._ErrorCode.GetHashCode();
