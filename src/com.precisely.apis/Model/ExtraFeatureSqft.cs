...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtraFeatureSqft :  IEquatable<ExtraFeatureSqft>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtraFeatureSqft" /> class.
        /// </summary>
        /// <param name="featureAreaSqFt">featureAreaSqFt.</param>
        /// <param name="areaIndicator">areaIndicator.</param>
        /// <param name="description">description.</param>
        public ExtraFeatureSqft(string featureAreaSqFt = default(string), string areaIndicator = default(string), string description = default(string))
        {
        ...
        {
            return this.Equals(input as ExtraFeatureSqft);
        }

        /// <summary>
        /// Returns true if ExtraFeatureSqft instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtraFeatureSqft to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtraFeatureSqft input)
        {
            if (input == null)
                return false;
