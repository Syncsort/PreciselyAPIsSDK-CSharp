...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POIBoundaryLocationRequest :  IEquatable<POIBoundaryLocationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as POIBoundaryLocationRequest);
        }

        /// <summary>
        /// Returns true if POIBoundaryLocationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of POIBoundaryLocationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POIBoundaryLocationRequest input)
        {
            if (input == null)
                return false;
