...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmploymentTheme :  IEquatable<EmploymentTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public EmploymentTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as EmploymentTheme);
        }

        /// <summary>
        /// Returns true if EmploymentTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of EmploymentTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmploymentTheme input)
        {
            if (input == null)
                return false;
