...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SitusAddress :  IEquatable<SitusAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SitusAddress" /> class.
        /// </summary>
        ...
        public SitusAddress(string mainAddressLine = default(string), string addressNumber = default(string), string streetPreDirection = default(string), string streetName = default(string), string streetType = default(string), string streetPostDirection = default(string), string unitType = default(string), string unitValue = default(string), string city = default(string), string state = default(string), string postCode1 = default(string), string postCode2 = default(string))
        {
        ...
        {
            return this.Equals(input as SitusAddress);
        }

        /// <summary>
        /// Returns true if SitusAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of SitusAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SitusAddress input)
        {
            if (input == null)
                return false;
