...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HealthTheme :  IEquatable<HealthTheme>, IValidatableObject
    {
        /// <summary>
        ...
        public HealthTheme(string boundaryRef = default(string), List<IndividualValueVariable> individualValueVariable = default(List<IndividualValueVariable>), List<RangeVariable> rangeVariable = default(List<RangeVariable>))
        {
        ...
        {
            return this.Equals(input as HealthTheme);
        }

        /// <summary>
        /// Returns true if HealthTheme instances are equal
        /// </summary>
        /// <param name="input">Instance of HealthTheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HealthTheme input)
        {
            if (input == null)
                return false;
