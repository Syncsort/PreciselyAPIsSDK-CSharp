...
namespace com.precisely.apis.Model
{
    ...
    public partial class TimezoneResponse :  IEquatable<TimezoneResponse>, IValidatableObject
    {
        ...
        public TimezoneResponse(string objectId = default(string), string timezoneName = default(string), string zoneType = default(string), long utcOffset = default(long), long dstOffset = default(long), long timestamp = default(long), Address1 matchedAddress = default(Address1), string country = default(string), string tzValidFrom = default(string), string tzValidUntill = default(string), string dstRule = default(string), string dstValidFrom = default(string), string dstValidUntill = default(string), string dstStartDateFormat = default(string), string dstEndDateFormat = default(string), string dstStartDate = default(string), string dstStartTime = default(string), string dstEndTime = default(string), string dstEndDate = default(string))
        {
