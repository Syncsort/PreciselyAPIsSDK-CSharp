...
namespace com.precisely.apis.Model
{
    ...
    public partial class PhoneVerification :  IEquatable<PhoneVerification>, IValidatableObject
    {
        ...
        public PhoneVerification(string phoneNumber = default(string), DeviceStatusNetwork network = default(DeviceStatusNetwork), string privacyConsentRequired = default(string))
        {
