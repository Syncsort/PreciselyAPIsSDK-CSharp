...
namespace com.precisely.apis.Model
{
    ...
    public partial class TypeaheadLocation :  IEquatable<TypeaheadLocation>, IValidatableObject
    {
        ...
        public TypeaheadLocation(string dataset = default(string), Match match = default(Match), Address address = default(Address), Poi poi = default(Poi), Distance distance = default(Distance), string unitTemp = default(string), string valueTemp = default(string), Geometry geometry = default(Geometry), int totalUnitCount = default(int), List<TypeaheadRange> ranges = default(List<TypeaheadRange>), Place place = default(Place))
        {
