...
namespace com.precisely.apis.Model
{
    ...
    public partial class TypeaheadLocation :  IEquatable<TypeaheadLocation>, IValidatableObject
    {
        ...
        public TypeaheadLocation(string dataset = default(string), Match1 match = default(Match1), Address2 address = default(Address2), Poi poi = default(Poi), Distance1 distance = default(Distance1), string unitTemp = default(string), string valueTemp = default(string), Geometry geometry = default(Geometry), int totalUnitCount = default(int), List<TypeaheadRange> ranges = default(List<TypeaheadRange>), Place1 place = default(Place1))
        {
