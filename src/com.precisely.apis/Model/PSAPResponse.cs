...
namespace com.precisely.apis.Model
{
    ...
    public partial class PSAPResponse :  IEquatable<PSAPResponse>
    {
        ...
        public PSAPResponse(string PsapId = null, string FccId = null, string Type = null, int? Count = null, string Agency = null, string Phone = null, County County = null, Coverage Coverage = null, ContactPerson ContactPerson = null, SiteDetails SiteDetails = null, MatchedAddress MailingAddress = null)
        {
            this.PsapId = PsapId;
            this.FccId = FccId;
            this.Type = Type;
        ...
        public bool Equals(PSAPResponse other)
        {
            ...
            return 
                (
                    this.PsapId == other.PsapId ||
                    this.PsapId != null &&
                    this.PsapId.Equals(other.PsapId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PsapId != null)
                    hash = hash * 59 + this.PsapId.GetHashCode();
                if (this.FccId != null)
