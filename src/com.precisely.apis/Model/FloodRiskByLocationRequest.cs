...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FloodRiskByLocationRequest :  IEquatable<FloodRiskByLocationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public FloodRiskByLocationRequest(List<RiskLocations> locations = default(List<RiskLocations>), FloodRiskPreferences preferences = default(FloodRiskPreferences))
        {
        ...
        {
            return this.Equals(input as FloodRiskByLocationRequest);
        }

        /// <summary>
        /// Returns true if FloodRiskByLocationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FloodRiskByLocationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FloodRiskByLocationRequest input)
        {
            if (input == null)
                return false;
