...
namespace com.precisely.apis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PBKeyResponse :  IEquatable<PBKeyResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PBKeyResponse(string key = default(string), Address matchedAddress = default(Address))
        {
            this.Key = key;
        ...
        {
            return this.Equals(input as PBKeyResponse);
        }

        /// <summary>
        /// Returns true if PBKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PBKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PBKeyResponse input)
        {
            if (input == null)
                return false;
