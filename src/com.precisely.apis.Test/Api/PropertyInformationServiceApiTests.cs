...
namespace com.precisely.apis.Test
{
    ...
    public class PropertyInformationServiceApiTests
    {
        ...
        public void GetParcelBoundaryByAddressTest()
        {
            ...
            //string address = null;
            //var response = instance.GetParcelBoundaryByAddress(address);
            //Assert.IsInstanceOf<ParcelBoundaryV2> (response, "response is ParcelBoundaryV2");
        }
        ...
        public void GetParcelBoundaryByLocationTest()
        {
            ...
            //var response = instance.GetParcelBoundaryByLocation(longitudelatitude);
            //Assert.IsInstanceOf<ParcelBoundaryV2> (response, "response is ParcelBoundaryV2");
        }
        
        /// <summary>
        /// Test GetParcelBoundaryByPreciselyID
        /// </summary>
        [Test]
        public void GetParcelBoundaryByPreciselyIDTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string preciselyID = null;
            //var response = instance.GetParcelBoundaryByPreciselyID(preciselyID);
            //Assert.IsInstanceOf<ParcelBoundaryV2> (response, "response is ParcelBoundaryV2");
        }
