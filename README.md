...
```
nuget pack -Build -OutputDirectory out com.precisely.apis.csproj
```
...
## Documentation for Models
 ...
 - [Model.AbsenteeOwner](docs/AbsenteeOwner.md)
 - [Model.Accuracy](docs/Accuracy.md)
 - [Model.Address](docs/Address.md)
 - [Model.Address1](docs/Address1.md)
 - [Model.Address2](docs/Address2.md)
 - [Model.AddressTime](docs/AddressTime.md)
 - [Model.AddressType](docs/AddressType.md)
 - [Model.AddressesByBoundaryRequest](docs/AddressesByBoundaryRequest.md)
 - [Model.AddressesCount](docs/AddressesCount.md)
 - [Model.AddressesDTO](docs/AddressesDTO.md)
 - [Model.AddressesPreferences](docs/AddressesPreferences.md)
 - [Model.AddressesResponse](docs/AddressesResponse.md)
 - [Model.Amenities](docs/Amenities.md)
 - [Model.Area](docs/Area.md)
 - [Model.AreaCodeInfo](docs/AreaCodeInfo.md)
 - [Model.AreaV2](docs/AreaV2.md)
 - [Model.AssetsAndWealthTheme](docs/AssetsAndWealthTheme.md)
 - [Model.BaseFloodElevation](docs/BaseFloodElevation.md)
 - [Model.BasementType](docs/BasementType.md)
 ...
 - [Model.BuildgClass](docs/BuildgClass.md)
 - [Model.BuildgCondition](docs/BuildgCondition.md)
 - [Model.BuildgFeaturesSqft](docs/BuildgFeaturesSqft.md)
 - [Model.BuildgImproveArea](docs/BuildgImproveArea.md)
 - [Model.BuildgImproveType](docs/BuildgImproveType.md)
 - [Model.BuildgQuality](docs/BuildgQuality.md)
 - [Model.BuildgStyle](docs/BuildgStyle.md)
 - [Model.BuildgType](docs/BuildgType.md)
 - [Model.BuildgView](docs/BuildgView.md)
 - [Model.BuildingSqftSource](docs/BuildingSqftSource.md)
 - [Model.BusinessId](docs/BusinessId.md)
 - [Model.CaExemptions](docs/CaExemptions.md)
 ...
 - [Model.CommunityGroup](docs/CommunityGroup.md)
 ...
 - [Model.CoolingType](docs/CoolingType.md)
 ...
 - [Model.CrimeRiskByAddressBatchRequest](docs/CrimeRiskByAddressBatchRequest.md)
 - [Model.CrimeRiskByLocationBatchRequest](docs/CrimeRiskByLocationBatchRequest.md)
 ...
 - [Model.DamageGroup](docs/DamageGroup.md)
 - [Model.Demographics](docs/Demographics.md)
 - [Model.DemographicsAdvancedPreferences](docs/DemographicsAdvancedPreferences.md)
 - [Model.DemographicsAdvancedRequest](docs/DemographicsAdvancedRequest.md)
 - [Model.DemographicsGeometry](docs/DemographicsGeometry.md)
 - [Model.DemographicsGeometryCRC](docs/DemographicsGeometryCRC.md)
 ...
 - [Model.Distance1](docs/Distance1.md)
 ...
 - [Model.EarthquakeDateTime](docs/EarthquakeDateTime.md)
 ...
 - [Model.EnergyType](docs/EnergyType.md)
 - [Model.ErrorCode](docs/ErrorCode.md)
 - [Model.ErrorInfo](docs/ErrorInfo.md)
 - [Model.ErrorInfo1](docs/ErrorInfo1.md)
 - [Model.EventsCount](docs/EventsCount.md)
 - [Model.ExpenditureTheme](docs/ExpenditureTheme.md)
 - [Model.ExteriorWalls](docs/ExteriorWalls.md)
 - [Model.ExtraFeatureSqft](docs/ExtraFeatureSqft.md)
 ...
 - [Model.FireEventV2](docs/FireEventV2.md)
 - [Model.FireEventsResponse](docs/FireEventsResponse.md)
 - [Model.FireEventsV2Response](docs/FireEventsV2Response.md)
 - [Model.FireHistory](docs/FireHistory.md)
 - [Model.FireHistoryV2](docs/FireHistoryV2.md)
 ...
 - [Model.FireRiskV2Response](docs/FireRiskV2Response.md)
 - [Model.FireRiskV2ResponseList](docs/FireRiskV2ResponseList.md)
 ...
 - [Model.FireplaceType](docs/FireplaceType.md)
 ...
 - [Model.FloorType](docs/FloorType.md)
 - [Model.FormattedTaxAddress](docs/FormattedTaxAddress.md)
 - [Model.Foundation](docs/Foundation.md)
 - [Model.FreeOrReducedPriceLunches](docs/FreeOrReducedPriceLunches.md)
 - [Model.FrequencyGroup](docs/FrequencyGroup.md)
 - [Model.FuelType](docs/FuelType.md)
 - [Model.GarageType](docs/GarageType.md)
 ...
 - [Model.GeolocationGeometry](docs/GeolocationGeometry.md)
 - [Model.Geometry](docs/Geometry.md)
 - [Model.GeometryCRC](docs/GeometryCRC.md)
 - [Model.GeometryProperties](docs/GeometryProperties.md)
 ...
 - [Model.GetPostalCodesAPIOutputUserFields](docs/GetPostalCodesAPIOutputUserFields.md)
 ...
 - [Model.HeatingType](docs/HeatingType.md)
 ...
 - [Model.InteriorWall](docs/InteriorWall.md)
 - [Model.IntermediatePoints](docs/IntermediatePoints.md)
 ...
 - [Model.MitigationGroup](docs/MitigationGroup.md)
 - [Model.Name](docs/Name.md)
 - [Model.Name1](docs/Name1.md)
 - [Model.NeighborhoodsResponse](docs/NeighborhoodsResponse.md)
 - [Model.Network](docs/Network.md)
 - [Model.OrganizationType](docs/OrganizationType.md)
 - [Model.OtherRooms](docs/OtherRooms.md)
 - [Model.OwnerVestType](docs/OwnerVestType.md)
 - [Model.Owners](docs/Owners.md)
 ...
 - [Model.ParcelBoundaryV2](docs/ParcelBoundaryV2.md)
 - [Model.ParcelV2](docs/ParcelV2.md)
 - [Model.ParentBusiness](docs/ParentBusiness.md)
 - [Model.Pbkey](docs/Pbkey.md)
 - [Model.PhoneVerification](docs/PhoneVerification.md)
 - [Model.PhoneVerificationOutput](docs/PhoneVerificationOutput.md)
 - [Model.Place](docs/Place.md)
 - [Model.Place1](docs/Place1.md)
 - [Model.PlacesResponse](docs/PlacesResponse.md)
 ...
 - [Model.PoolType](docs/PoolType.md)
 ...
 - [Model.PriorSaleCode](docs/PriorSaleCode.md)
 - [Model.PropSiteInfluene](docs/PropSiteInfluene.md)
 - [Model.Properties](docs/Properties.md)
 - [Model.PropertyAttributes](docs/PropertyAttributes.md)
 - [Model.PropertyGeometry](docs/PropertyGeometry.md)
 - [Model.PropertyInfoAddressRequest](docs/PropertyInfoAddressRequest.md)
 - [Model.PropertyInfoPreferences](docs/PropertyInfoPreferences.md)
 - [Model.PropertyInfoResponse](docs/PropertyInfoResponse.md)
 - [Model.PropertyInfoResponses](docs/PropertyInfoResponses.md)
 - [Model.PropertyInformationGeometry](docs/PropertyInformationGeometry.md)
 - [Model.PropertyInformationGeometryCRC](docs/PropertyInformationGeometryCRC.md)
 ...
 - [Model.RiskGeometry](docs/RiskGeometry.md)
 - [Model.RiskLocations](docs/RiskLocations.md)
 - [Model.RiskPreferences](docs/RiskPreferences.md)
 - [Model.RisksBoundaries](docs/RisksBoundaries.md)
 - [Model.RisksCrimeTheme](docs/RisksCrimeTheme.md)
 - [Model.RisksGeometryCRC](docs/RisksGeometryCRC.md)
 - [Model.Road](docs/Road.md)
 - [Model.RoofCoverType](docs/RoofCoverType.md)
 - [Model.RoofFrameType](docs/RoofFrameType.md)
 - [Model.RoofShapeType](docs/RoofShapeType.md)
 ...
 - [Model.SeverityGroup](docs/SeverityGroup.md)
 ...
 - [Model.SitusAddress](docs/SitusAddress.md)
 ...
 - [Model.TypeaheadLocation](docs/TypeaheadLocation.md)
 - [Model.TypeaheadLocations](docs/TypeaheadLocations.md)
 ...
 - [Model.ValidatePhoneNumberAPIRequest](docs/ValidatePhoneNumberAPIRequest.md)
 - [Model.ValidatePhoneNumberAPIRequestInput](docs/ValidatePhoneNumberAPIRequestInput.md)
 - [Model.ValidatePhoneNumberAPIRequestInputRow](docs/ValidatePhoneNumberAPIRequestInputRow.md)
 - [Model.WaterBody](docs/WaterBody.md)
 - [Model.WaterBodyResponse](docs/WaterBodyResponse.md)
 - [Model.ZonesAddress](docs/ZonesAddress.md)
 - [Model.ZonesBoundaryGeometry](docs/ZonesBoundaryGeometry.md)
 - [Model.ZonesContactDetails](docs/ZonesContactDetails.md)
 - [Model.ZonesGeometry](docs/ZonesGeometry.md)
 - [Model.ZonesParentBusiness](docs/ZonesParentBusiness.md)
 - [Model.ZonesPoi](docs/ZonesPoi.md)
 - [Model.ZonesPoiClassification](docs/ZonesPoiClassification.md)
 - [Model.ZonesPoiGeometry](docs/ZonesPoiGeometry.md)
 - [Model.ZonesSic](docs/ZonesSic.md)
